...
class TrialFormBlockController extends BlockController {

	public $btTable = 'btForm';
	public $btName = "Trial form";
	...
	public $btTrailFormSubmit = 'btTrailFormSubmit';
	...
	public function getBlockTypeDescription() {
		return t("Build simple trial forms .");
	}
	...
	function action_submit_form() { 
		...
		if(count($errors)){			
			...
			/****************** Insert data into Form submit table***************/
			
			$varib = array( intval($this->bID), $answerSetID,$qsID);
			$query = "insert into {$this->btTrailFormSubmit} (bID, asID,questionSetId) values (?,?,?)";
			$db->query($query,$varib);
	...
	function delete() { 
		...
		$miniSurvey=new TrailMiniSurvey();
...
class TrailFormBlockStatistics extends Concrete5_Controller_Block_FormStatistics {}
class TrailMiniSurvey extends Concrete5_Controller_Block_FormMinisurvey {}
